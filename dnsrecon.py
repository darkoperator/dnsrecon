...
def usage():
    ...
    print("   -r, --range       <range>    IP range for reverse look-up brute force in formats (first-last) or in")
    print("                                (range/bitmask).")
    print("   -n, --name_server <name>     Domain server to use. If none is given, the SOA of the target will be used.")
    print("   -D, --dictionary  <file>     Dictionary file of sub-domain and hostnames to use for brute force.")
    print("   -f                           Filter out of brute force domain lookup records that resolve to the wildcard")
    print("                                defined IP address when saving records.")
    print("   -t, --type        <types>    Specify the type of enumeration to perform:")
    print("                                std       Enumerate general record types: SOA, NS, A, AAAA, MX and SRV if AXRF") 
    print("                                          on the NS servers fail.")
    print("                                rvl       Reverse look up of a given CIDR or IP range.")
    print("                                brt       Brute force domains and hosts using a given dictionary.")
    print("                                srv       Enumerate common SRV records for a given domain.")
    print("                                axfr      Test all NS servers in a domain for zone transfers.")
    print("                                goo       Perform Google search for sub-domains and hosts.")
    print("                                snoop     Perform cache snooping against all NS servers for a given domain,")
    print("                                          testing all with file containing the domains, file given with -D")
    print("                                          option.")
    print("                                tld       Remove the TLD of given domain and test against all TLDs registered")
    print("                                          in IANA.")
    print("                                zonewalk  Perform a DNSSEC zone walk using NSEC records.")
    print("   -a                           Perform AXFR with the standard enumeration.")
    print("   -s                           Perform a reverse look-up of IPv4 ranges in the SPF record of the targeted domain")
    print("                                with the standard enumeration.")
    print("   -g                           Perform Google enumeration with the standard enumeration.")
    print("   -w                           Do deep whois record analysis and reverse look-up of IP ranges found through")
    print("                                whois when doing a standard query.")
    print("   -z                           Performs a DNSSEC zone walk with the standard enumeration.")
    print("   --threads          <number>  Number of threads to use in range reverse look-up, forward look-up, brute force")
    print("                                and SRV record enumeration.")
    ...
    print("   --iw                         Continua brute forcing a domain even if a wildcard record resolution is discovered.")
