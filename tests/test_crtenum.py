...
def test_is_transient_error():
    assert not is_transient_error(httpx.TimeoutException('Connection timeout'))
    ...
    assert is_transient_error(httpx.RequestError(message='Request error', request=httpx.Request(url='https://crt.sh', method='GET')))
